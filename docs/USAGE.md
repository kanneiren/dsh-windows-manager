...
[中文](USAGE.zh-CN.md) | [Back to README](../README.md)

This document supplements the README with installation and uninstallation details, Mainland China network access, opening methods, runtime selection, tray menu, update policy, graceful shutdown, port safety, multiple instances, permissions and security software, build and test, GitHub Actions, and icon provenance.
